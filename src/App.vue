  ...
  <section class="section" id="app">
    <div class="container">
      <section class="hero is-small" style="background-image: url(https://opccmc.org/wp-content/uploads/2019/08/green-bg.png?id=97)">
        ...
        <p style="padding-bottom: 6px; padding-left: 24px; color:#CF0000">Inflation Advisory: Inflation has been occurring at an annualized rate of 7.4% as of August 2022. The tool’s base salary figures are dervied from a calculation using the Annual Federal Poverty Rate as published in January 2022, which would not reflect the further price increases which have occurred since then.  The Federal Poverty Rate will not be updated again untl January 2023.  Users should consider increasing the base salary suggested by the Compensation Tool to account for inflation through the end of 2022.</p>
